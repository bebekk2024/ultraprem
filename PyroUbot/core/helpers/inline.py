# Ensure compatibility shim runs before pykeyboard tries to import pyrogram internals
try:
    ...
    try:
        ...
        # If shim cannot be imported for any reason, continue — import error will show later
        pass
